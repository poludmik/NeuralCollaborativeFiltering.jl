...
# model_type = DotProductNCFModel
# weights_path = "weights\\dot_product_ncf\\model_dim60_bs1024_ep11_lr0.005.jld2"
...
# weights_path, plot_path = train_model(df_train, df_test, m, n_epochs=101, lr=0.005, bs=1024)
